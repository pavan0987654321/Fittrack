      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute right-0 mt-3 w-80 sm:w-96 bg-dark-850 border border-white/10 rounded-2xl shadow-2xl z-[200] flex flex-col backdrop-blur-md overflow-hidden"
          >
